...
const features = [
  {
    ...
    description: 'Complete e-commerce solution with payments, subscriptions, and billing.',
  },
  {
    icon: Shield,
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              A powerful, scalable e-commerce solution built with Next.js and Django REST API.
