    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(blank=True, null=True, storage=common.storages.PublicS3Boto3StorageWithCDN, upload_to=common.storages.UniqueFilePathGenerator('vendors/logos'))),
                ('banner', models.ImageField(blank=True, null=True, storage=common.storages.PublicS3Boto3StorageWithCDN, upload_to=common.storages.UniqueFilePathGenerator('vendors/banners'))),
                ...
                ('commission_tier', models.CharField(choices=[('standard', 'Standard'), ('gold', 'Gold'), ('platinum', 'Platinum')], default='standard', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('id', hashid_field.field.HashidAutoField(alphabet='abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890', min_length=7, prefix='', primary_key=True, serialize=False)),
                ('doc_type', models.CharField(choices=[('gst', 'GST Certificate'), ('pan', 'PAN Card'), ('cancel_cheque', 'Cancelled Cheque'), ('other', 'Other')], max_length=50)),
                ('doc_number', models.CharField(blank=True, max_length=100)),
                ('file', models.FileField(storage=common.storages.PublicS3Boto3StorageWithCDN, upload_to=common.storages.UniqueFilePathGenerator('vendors/documents'))),
