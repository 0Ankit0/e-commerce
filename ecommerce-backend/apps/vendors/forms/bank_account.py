...
class BankAccountForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Submit('submit', 'Save Bank Account', css_class='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded')
        )

    class Meta:
        model = BankAccount
        fields = (
            "vendor", "account_name", "account_number", "ifsc_code", 
            "bank_name", "is_primary", "verification_status"
        )
