...
class VendorForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Submit('submit', 'Save Vendor', css_class='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded')
        )

    class Meta:
        model = Vendor
        fields = (
            "business_name", "display_name", "slug", "description", 
            "logo", "banner", "gstin", "pan", "status", "rating",
            "commission_tier", "approved_at"
        )
        widgets = {
