...
class ProductVariantForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Submit('submit', 'Save Variant', css_class='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded')
        )

    class Meta:
        model = ProductVariant
        fields = (
            "product", "sku", "name", "mrp", "selling_price", 
            "cost_price", "attributes", "weight", "dimensions", 
