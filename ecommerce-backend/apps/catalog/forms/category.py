    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Div(
             ...
             Div(
                Div('attributes', css_class='col-span-12'),
                css_class='grid grid-cols-12 gap-4'
            ),
             Div(
                Div('is_active', css_class='col-span-12'),
                css_class='grid grid-cols-12 gap-4'
            ),
            Submit('submit', 'Save Category', css_class='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded')
        )

    class Meta:
        model = Category
        fields = (
            "parent", "name", "slug", "description", "icon", 
            "image", "sort_order", "is_active", "attributes"
        )
        widgets = {
