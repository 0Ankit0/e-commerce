...
class ProductForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Div(Div("short_description", css_class="col-span-12"), css_class="grid grid-cols-12 gap-4"),
            Div(Div("description", css_class="col-span-12"), css_class="grid grid-cols-12 gap-4"),
            Div(Div("specifications", css_class="col-span-12"), css_class="grid grid-cols-12 gap-4"),
            Div(Div("seo_data", css_class="col-span-12"), css_class="grid grid-cols-12 gap-4"),
            Submit(
                "submit",
                "Save Product",
