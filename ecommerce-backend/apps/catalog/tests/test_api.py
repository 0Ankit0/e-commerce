...
class CatalogAPITests(APITestCase):
    def setUp(self):
        ...
        # Public data
        self.p1 = Product.objects.create(vendor=self.vendor, category=self.category, name='iPhone 13', slug='iphone-13', status='published')
        self.p2 = Product.objects.create(vendor=self.vendor, category=self.category, name='Galaxy S21', slug='galaxy-s21', status='published')
