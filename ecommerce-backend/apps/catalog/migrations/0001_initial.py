    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(blank=True, null=True, storage=common.storages.PublicS3Boto3StorageWithCDN, upload_to=common.storages.UniqueFilePathGenerator('brands/logos'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('icon', models.ImageField(blank=True, null=True, storage=common.storages.PublicS3Boto3StorageWithCDN, upload_to=common.storages.UniqueFilePathGenerator('categories/icons'))),
                ('image', models.ImageField(blank=True, null=True, storage=common.storages.PublicS3Boto3StorageWithCDN, upload_to=common.storages.UniqueFilePathGenerator('categories/images'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('draft', 'Draft'), ('pending', 'Pending Approval'), ('active', 'Active'), ('inactive', 'Inactive'), ('deleted', 'Deleted')], default='draft', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('id', hashid_field.field.HashidAutoField(alphabet='abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890', min_length=7, prefix='', primary_key=True, serialize=False)),
                ('image', models.ImageField(storage=common.storages.PublicS3Boto3StorageWithCDN, upload_to=common.storages.UniqueFilePathGenerator('products/images'))),
                ('thumbnail', models.ImageField(blank=True, null=True, storage=common.storages.PublicS3Boto3StorageWithCDN, upload_to=common.storages.UniqueFilePathGenerator('products/thumbnails'))),
