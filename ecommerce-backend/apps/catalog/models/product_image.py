...
class ProductImage(TimestampedMixin, models.Model):
    ...
    image: models.ImageField = models.ImageField(
        storage=PublicS3Boto3StorageWithCDN, upload_to=UniqueFilePathGenerator("products/images")
    )
    ...
    alt_text: models.CharField = models.CharField(max_length=255, blank=True)
