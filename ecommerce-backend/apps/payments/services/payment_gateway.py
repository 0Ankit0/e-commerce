...
def process_payment(amount: float, currency: str = "USD", source: str | None = None) -> dict:
    """
...
def process_refund(payment_id: str) -> dict:
    ...
    return {"success": True, "refund_id": refund_id, "original_payment_id": payment_id, "status": "REFUNDED"}
