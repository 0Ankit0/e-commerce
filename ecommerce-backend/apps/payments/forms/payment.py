...
class PaymentForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Div(Div("gateway_response", css_class="col-span-12"), css_class="grid grid-cols-12 gap-4"),
            Div(Div("failure_reason", css_class="col-span-12"), css_class="grid grid-cols-12 gap-4"),
            Submit(
                "submit",
                "Save Payment",
