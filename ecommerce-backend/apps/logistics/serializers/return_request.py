...
class ReturnSerializer(serializers.ModelSerializer):
    ...
    order_item_id = rest.HashidSerializerCharField(source_field="orders.OrderItem.id", source="order_item.id", read_only=True)
    
    class Meta:
        model = Return
        fields = (
            "id", "return_number", "order_id", "order_item_id", 
            "status", "reason", "reason_text", "images", 
            "refund_amount", "reverse_shipment", 
