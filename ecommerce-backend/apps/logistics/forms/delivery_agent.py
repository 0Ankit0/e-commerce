...
class DeliveryAgentForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Submit('submit', 'Save Delivery Agent', css_class='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded')
        )

    class Meta:
        model = DeliveryAgent
        fields = (
            "branch", "user", "vehicle_number", "vehicle_type", 
            "status", "capacity", "current_load", "current_lat", 
