...
class BranchForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Div(Div("address", css_class="col-span-12"), css_class="grid grid-cols-12 gap-4"),
            Div(Div("service_pincodes", css_class="col-span-12"), css_class="grid grid-cols-12 gap-4"),
            Submit(
                "submit",
                "Save Branch",
    ...
    class Meta:
        model = Branch
        fields = ("hub", "name", "code", "address", "service_pincodes", "contact_phone", "agent_capacity", "is_active")
        widgets = {
