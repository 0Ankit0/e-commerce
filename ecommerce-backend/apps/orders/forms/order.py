...
class OrderForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Div(Div("notes", css_class="col-span-12"), css_class="grid grid-cols-12 gap-4"),
            Submit(
                "submit", "Save Order", css_class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
            ),
        )
